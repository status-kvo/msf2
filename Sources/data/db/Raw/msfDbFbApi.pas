...
{$ENDIF}
	...
	public
		...
		class procedure setVersionError(status: Status; interfaceName: AnsiString;
	...
	ResultSet_getInfoPtr = procedure(this: ResultSet; status: Status; itemsLength: Cardinal; items: BytePtr; bufferLength: Cardinal; buffer: BytePtr); cdecl;
	...
	Batch_addBlobPtr = procedure(this: Batch; status: Status; length: Cardinal; inBuffer: Pointer; blobId: ISC_QUADPtr; parLength: Cardinal; par: BytePtr); cdecl;
	...
	Request_startAndSendPtr = procedure(this: Request; status: Status; tra: Transaction; level: Integer; msgType: Cardinal; length: Cardinal; message: Pointer); cdecl;
	...
	Attachment_createBatchPtr = function(this: Attachment; status: Status; transaction: Transaction; stmtLength: Cardinal; sqlStmt: PAnsiChar; dialect: Cardinal; inMetadata: MessageMetadata; parLength: Cardinal; par: BytePtr): Batch; cdecl;
	...
	Util_decodeTimeTzPtr = procedure(this: Util; status: Status; timeTz: ISC_TIME_TZPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
	Util_decodeTimeStampTzPtr = procedure(this: Util; status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
	Util_encodeTimeTzPtr = procedure(this: Util; status: Status; timeTz: ISC_TIME_TZPtr; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); cdecl;
	Util_encodeTimeStampTzPtr = procedure(this: Util; status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: Cardinal; month: Cardinal; day: Cardinal; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); cdecl;
	Util_getInt128Ptr = function(this: Util; status: Status): Int128; cdecl;
	Util_decodeTimeTzExPtr = procedure(this: Util; status: Status; timeTz: ISC_TIME_TZ_EXPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
	Util_decodeTimeStampTzExPtr = procedure(this: Util; status: Status; timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
	...
	TracePlugin_trace_dsql_restartPtr = function(this: TracePlugin; connection: TraceDatabaseConnection; transaction: TraceTransaction; statement: TraceSQLStatement; number: Cardinal): Boolean; cdecl;
	TracePlugin_trace_proc_compilePtr = function(this: TracePlugin; connection: TraceDatabaseConnection; procedure_: TraceProcedure; time_millis: Int64; proc_result: Cardinal): Boolean; cdecl;
	TracePlugin_trace_func_compilePtr = function(this: TracePlugin; connection: TraceDatabaseConnection; function_: TraceFunction; time_millis: Int64; func_result: Cardinal): Boolean; cdecl;
	TracePlugin_trace_trigger_compilePtr = function(this: TracePlugin; connection: TraceDatabaseConnection; trigger: TraceTrigger; time_millis: Int64; trig_result: Cardinal): Boolean; cdecl;
	...
	ReplicatedTransaction_updateRecordPtr = procedure(this: ReplicatedTransaction; status: Status; name: PAnsiChar; orgRecord: ReplicatedRecord; newRecord: ReplicatedRecord); cdecl;
	...
	ReplicatedSession_startTransactionPtr = function(this: ReplicatedSession; status: Status; transaction: Transaction; number: Int64): ReplicatedTransaction; cdecl;
	...
	ProfilerPlugin_startSessionPtr = function(this: ProfilerPlugin; status: Status; description: PAnsiChar; options: PAnsiChar; timestamp: ISC_TIMESTAMP_TZ): ProfilerSession; cdecl;
	...
	ProfilerSession_defineStatementPtr = procedure(this: ProfilerSession; status: Status; statementId: Int64; parentStatementId: Int64; type_: PAnsiChar; packageName: PAnsiChar; routineName: PAnsiChar; sqlText: PAnsiChar); cdecl;
	ProfilerSession_defineCursorPtr = procedure(this: ProfilerSession; statementId: Int64; cursorId: Cardinal; name: PAnsiChar; line: Cardinal; column: Cardinal); cdecl;
	ProfilerSession_defineRecordSourcePtr = procedure(this: ProfilerSession; statementId: Int64; cursorId: Cardinal; recSourceId: Cardinal; level: Cardinal; accessPath: PAnsiChar; parentRecSourceId: Cardinal); cdecl;
	ProfilerSession_onRequestStartPtr = procedure(this: ProfilerSession; status: Status; statementId: Int64; requestId: Int64; callerStatementId: Int64; callerRequestId: Int64; timestamp: ISC_TIMESTAMP_TZ); cdecl;
	ProfilerSession_onRequestFinishPtr = procedure(this: ProfilerSession; status: Status; statementId: Int64; requestId: Int64; timestamp: ISC_TIMESTAMP_TZ; stats: ProfilerStats); cdecl;
	ProfilerSession_beforePsqlLineColumnPtr = procedure(this: ProfilerSession; statementId: Int64; requestId: Int64; line: Cardinal; column: Cardinal); cdecl;
	ProfilerSession_afterPsqlLineColumnPtr = procedure(this: ProfilerSession; statementId: Int64; requestId: Int64; line: Cardinal; column: Cardinal; stats: ProfilerStats); cdecl;
	ProfilerSession_beforeRecordSourceOpenPtr = procedure(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal); cdecl;
	ProfilerSession_afterRecordSourceOpenPtr = procedure(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats); cdecl;
	ProfilerSession_beforeRecordSourceGetRecordPtr = procedure(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal); cdecl;
	ProfilerSession_afterRecordSourceGetRecordPtr = procedure(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats); cdecl;
	...
	Batch = class(ReferenceCounted)
		...
		const CURRENT_VERSION = Byte(Batch.VERSION1);
	...
	RequestImpl = class(Request)
		...
		procedure startAndSend(status: Status; tra: Transaction; level: Integer; msgType: Cardinal; length: Cardinal; message: Pointer); virtual; abstract;
	...
	Attachment = class(ReferenceCounted)
		...
		function createBatch(status: Status; transaction: Transaction; stmtLength: Cardinal; sqlStmt: PAnsiChar; dialect: Cardinal; inMetadata: MessageMetadata; parLength: Cardinal; par: BytePtr): Batch;
	...
	AttachmentImpl = class(Attachment)
		...
		function createBatch(status: Status; transaction: Transaction; stmtLength: Cardinal; sqlStmt: PAnsiChar; dialect: Cardinal; inMetadata: MessageMetadata; parLength: Cardinal; par: BytePtr): Batch; virtual; abstract;
	...
	Util = class(Versioned)
		...
		procedure decodeTimeTz(status: Status; timeTz: ISC_TIME_TZPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
		procedure decodeTimeStampTz(status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
		procedure encodeTimeTz(status: Status; timeTz: ISC_TIME_TZPtr; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar);
		procedure encodeTimeStampTz(status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: Cardinal; month: Cardinal; day: Cardinal; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar);
		function getInt128(status: Status): Int128;
		procedure decodeTimeTzEx(status: Status; timeTz: ISC_TIME_TZ_EXPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
		procedure decodeTimeStampTzEx(status: Status; timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
	end;
	...
	UtilImpl = class(Util)
		...
		procedure decodeTimeTz(status: Status; timeTz: ISC_TIME_TZPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); virtual; abstract;
		procedure decodeTimeStampTz(status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); virtual; abstract;
		procedure encodeTimeTz(status: Status; timeTz: ISC_TIME_TZPtr; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); virtual; abstract;
		procedure encodeTimeStampTz(status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: Cardinal; month: Cardinal; day: Cardinal; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); virtual; abstract;
		function getInt128(status: Status): Int128; virtual; abstract;
		procedure decodeTimeTzEx(status: Status; timeTz: ISC_TIME_TZ_EXPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); virtual; abstract;
		procedure decodeTimeStampTzEx(status: Status; timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); virtual; abstract;
	end;
	...
	TracePlugin = class(ReferenceCounted)
		...
		function trace_dsql_restart(connection: TraceDatabaseConnection; transaction: TraceTransaction; statement: TraceSQLStatement; number: Cardinal): Boolean;
	...
	TracePluginImpl = class(TracePlugin)
		...
		function trace_dsql_restart(connection: TraceDatabaseConnection; transaction: TraceTransaction; statement: TraceSQLStatement; number: Cardinal): Boolean; virtual; abstract;
		function trace_proc_compile(connection: TraceDatabaseConnection; procedure_: TraceProcedure; time_millis: Int64; proc_result: Cardinal): Boolean; virtual; abstract;
		function trace_func_compile(connection: TraceDatabaseConnection; function_: TraceFunction; time_millis: Int64; func_result: Cardinal): Boolean; virtual; abstract;
		function trace_trigger_compile(connection: TraceDatabaseConnection; trigger: TraceTrigger; time_millis: Int64; trig_result: Cardinal): Boolean; virtual; abstract;
	end;
	...
	ProfilerPluginImpl = class(ProfilerPlugin)
		...
		function startSession(status: Status; description: PAnsiChar; options: PAnsiChar; timestamp: ISC_TIMESTAMP_TZ): ProfilerSession; virtual; abstract;
	...
	ProfilerSession = class(Disposable)
		...
		procedure defineStatement(status: Status; statementId: Int64; parentStatementId: Int64; type_: PAnsiChar; packageName: PAnsiChar; routineName: PAnsiChar; sqlText: PAnsiChar);
		...
		procedure onRequestStart(status: Status; statementId: Int64; requestId: Int64; callerStatementId: Int64; callerRequestId: Int64; timestamp: ISC_TIMESTAMP_TZ);
	...
	ProfilerSessionImpl = class(ProfilerSession)
		...
		procedure defineStatement(status: Status; statementId: Int64; parentStatementId: Int64; type_: PAnsiChar; packageName: PAnsiChar; routineName: PAnsiChar; sqlText: PAnsiChar); virtual; abstract;
		...
		procedure onRequestStart(status: Status; statementId: Int64; requestId: Int64; callerStatementId: Int64; callerRequestId: Int64; timestamp: ISC_TIMESTAMP_TZ); virtual; abstract;
		procedure onRequestFinish(status: Status; statementId: Int64; requestId: Int64; timestamp: ISC_TIMESTAMP_TZ; stats: ProfilerStats); virtual; abstract;
		...
		procedure afterRecordSourceOpen(statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats); virtual; abstract;
		...
		procedure afterRecordSourceGetRecord(statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats); virtual; abstract;
	end;
...
function Attachment.createBatch(status: Status; transaction: Transaction; stmtLength: Cardinal; sqlStmt: PAnsiChar; dialect: Cardinal; inMetadata: MessageMetadata; parLength: Cardinal; par: BytePtr): Batch;
begin
	if (vTable.version < 4) then begin
		Result := nil;
	end
...
procedure Util.decodeTimeTz(status: Status; timeTz: ISC_TIME_TZPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
begin
	if (vTable.version < 3) then begin
	end
	else begin
...
procedure Util.decodeTimeStampTz(status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
begin
	if (vTable.version < 3) then begin
	end
	else begin
...
procedure Util.encodeTimeTz(status: Status; timeTz: ISC_TIME_TZPtr; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar);
begin
	if (vTable.version < 3) then begin
	end
	else begin
...
procedure Util.encodeTimeStampTz(status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: Cardinal; month: Cardinal; day: Cardinal; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar);
begin
	if (vTable.version < 3) then begin
	end
	else begin
...
procedure Util.decodeTimeTzEx(status: Status; timeTz: ISC_TIME_TZ_EXPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
begin
	if (vTable.version < 4) then begin
	end
	else begin
...
procedure Util.decodeTimeStampTzEx(status: Status; timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
begin
	if (vTable.version < 4) then begin
	end
	else begin
...
function TracePlugin.trace_dsql_restart(connection: TraceDatabaseConnection; transaction: TraceTransaction; statement: TraceSQLStatement; number: Cardinal): Boolean;
begin
	if (vTable.version < 4) then begin
		Result := false;
	end
...
function TracePlugin.trace_proc_compile(connection: TraceDatabaseConnection; procedure_: TraceProcedure; time_millis: Int64; proc_result: Cardinal): Boolean;
begin
	if (vTable.version < 5) then begin
		Result := false;
	end
...
function TracePlugin.trace_func_compile(connection: TraceDatabaseConnection; function_: TraceFunction; time_millis: Int64; func_result: Cardinal): Boolean;
begin
	if (vTable.version < 5) then begin
		Result := false;
	end
...
function TracePlugin.trace_trigger_compile(connection: TraceDatabaseConnection; trigger: TraceTrigger; time_millis: Int64; trig_result: Cardinal): Boolean;
begin
	if (vTable.version < 5) then begin
		Result := false;
	end
...
procedure ProfilerSession.defineStatement(status: Status; statementId: Int64; parentStatementId: Int64; type_: PAnsiChar; packageName: PAnsiChar; routineName: PAnsiChar; sqlText: PAnsiChar);
begin
...
procedure ProfilerSession.defineRecordSource(statementId: Int64; cursorId: Cardinal; recSourceId: Cardinal; level: Cardinal; accessPath: PAnsiChar; parentRecSourceId: Cardinal);
begin
	ProfilerSessionVTable(vTable).defineRecordSource(Self, statementId, cursorId, recSourceId, level, accessPath, parentRecSourceId);
end;

procedure ProfilerSession.onRequestStart(status: Status; statementId: Int64; requestId: Int64; callerStatementId: Int64; callerRequestId: Int64; timestamp: ISC_TIMESTAMP_TZ);
begin
...
procedure ProfilerSession.afterRecordSourceOpen(statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats);
begin
...
procedure ProfilerSession.afterRecordSourceGetRecord(statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats);
begin
...
procedure ResultSetImpl_getInfoDispatcher(this: ResultSet; status: Status; itemsLength: Cardinal; items: BytePtr; bufferLength: Cardinal; buffer: BytePtr); cdecl;
begin
...
function StatementImpl_createBatchDispatcher(this: Statement; status: Status; inMetadata: MessageMetadata; parLength: Cardinal; par: BytePtr): Batch; cdecl;
begin
	Result := nil;
...
procedure BatchImpl_addBlobDispatcher(this: Batch; status: Status; length: Cardinal; inBuffer: Pointer; blobId: ISC_QUADPtr; parLength: Cardinal; par: BytePtr); cdecl;
begin
...
procedure BatchImpl_getInfoDispatcher(this: Batch; status: Status; itemsLength: Cardinal; items: BytePtr; bufferLength: Cardinal; buffer: BytePtr); cdecl;
begin
...
procedure RequestImpl_startAndSendDispatcher(this: Request; status: Status; tra: Transaction; level: Integer; msgType: Cardinal; length: Cardinal; message: Pointer); cdecl;
begin
...
function AttachmentImpl_createBatchDispatcher(this: Attachment; status: Status; transaction: Transaction; stmtLength: Cardinal; sqlStmt: PAnsiChar; dialect: Cardinal; inMetadata: MessageMetadata; parLength: Cardinal; par: BytePtr): Batch; cdecl;
begin
	Result := nil;
...
function WireCryptPluginImpl_getSpecificDataDispatcher(this: WireCryptPlugin; status: Status; keyType: PAnsiChar; length: CardinalPtr): BytePtr; cdecl;
begin
	Result := nil;
	Result := WireCryptPluginImpl(this).getSpecificData(status, keyType, length);
end;

procedure WireCryptPluginImpl_setSpecificDataDispatcher(this: WireCryptPlugin; status: Status; keyType: PAnsiChar; length: Cardinal; data: BytePtr); cdecl;
begin
...
procedure DbCryptPluginImpl_setKeyDispatcher(this: DbCryptPlugin; status: Status; length: Cardinal; sources: KeyHolderPluginPtr; keyName: PAnsiChar); cdecl;
begin
...
procedure UtilImpl_decodeTimeTzDispatcher(this: Util; status: Status; timeTz: ISC_TIME_TZPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
begin
	UtilImpl(this).decodeTimeTz(status, timeTz, hours, minutes, seconds, fractions, timeZoneBufferLength, timeZoneBuffer);
end;

procedure UtilImpl_decodeTimeStampTzDispatcher(this: Util; status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
begin
...
procedure UtilImpl_encodeTimeTzDispatcher(this: Util; status: Status; timeTz: ISC_TIME_TZPtr; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); cdecl;
begin
	UtilImpl(this).encodeTimeTz(status, timeTz, hours, minutes, seconds, fractions, timeZone);
end;

procedure UtilImpl_encodeTimeStampTzDispatcher(this: Util; status: Status; timeStampTz: ISC_TIMESTAMP_TZPtr; year: Cardinal; month: Cardinal; day: Cardinal; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); cdecl;
begin
...
procedure UtilImpl_decodeTimeTzExDispatcher(this: Util; status: Status; timeTz: ISC_TIME_TZ_EXPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
begin
	UtilImpl(this).decodeTimeTzEx(status, timeTz, hours, minutes, seconds, fractions, timeZoneBufferLength, timeZoneBuffer);
end;

procedure UtilImpl_decodeTimeStampTzExDispatcher(this: Util; status: Status; timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); cdecl;
begin
...
procedure OffsetsCallbackImpl_setOffsetDispatcher(this: OffsetsCallback; status: Status; index: Cardinal; offset: Cardinal; nullOffset: Cardinal); cdecl;
begin
...
function TracePluginImpl_trace_dsql_restartDispatcher(this: TracePlugin; connection: TraceDatabaseConnection; transaction: TraceTransaction; statement: TraceSQLStatement; number: Cardinal): Boolean; cdecl;
begin
	Result := false;
	Result := TracePluginImpl(this).trace_dsql_restart(connection, transaction, statement, number);
end;

function TracePluginImpl_trace_proc_compileDispatcher(this: TracePlugin; connection: TraceDatabaseConnection; procedure_: TraceProcedure; time_millis: Int64; proc_result: Cardinal): Boolean; cdecl;
begin
	Result := false;
	Result := TracePluginImpl(this).trace_proc_compile(connection, procedure_, time_millis, proc_result);
end;

function TracePluginImpl_trace_func_compileDispatcher(this: TracePlugin; connection: TraceDatabaseConnection; function_: TraceFunction; time_millis: Int64; func_result: Cardinal): Boolean; cdecl;
begin
	Result := false;
	Result := TracePluginImpl(this).trace_func_compile(connection, function_, time_millis, func_result);
end;

function TracePluginImpl_trace_trigger_compileDispatcher(this: TracePlugin; connection: TraceDatabaseConnection; trigger: TraceTrigger; time_millis: Int64; trig_result: Cardinal): Boolean; cdecl;
begin
	Result := false;
...
procedure Int128Impl_toStringDispatcher(this: Int128; status: Status; from: FB_I128Ptr; scale: Integer; bufferLength: Cardinal; buffer: PAnsiChar); cdecl;
begin
...
procedure ReplicatedTransactionImpl_insertRecordDispatcher(this: ReplicatedTransaction; status: Status; name: PAnsiChar; record_: ReplicatedRecord); cdecl;
begin
	ReplicatedTransactionImpl(this).insertRecord(status, name, record_);
end;

procedure ReplicatedTransactionImpl_updateRecordDispatcher(this: ReplicatedTransaction; status: Status; name: PAnsiChar; orgRecord: ReplicatedRecord; newRecord: ReplicatedRecord); cdecl;
begin
	ReplicatedTransactionImpl(this).updateRecord(status, name, orgRecord, newRecord);
end;

procedure ReplicatedTransactionImpl_deleteRecordDispatcher(this: ReplicatedTransaction; status: Status; name: PAnsiChar; record_: ReplicatedRecord); cdecl;
begin
...
function ReplicatedSessionImpl_startTransactionDispatcher(this: ReplicatedSession; status: Status; transaction: Transaction; number: Int64): ReplicatedTransaction; cdecl;
begin
	Result := nil;
...
function ProfilerPluginImpl_startSessionDispatcher(this: ProfilerPlugin; status: Status; description: PAnsiChar; options: PAnsiChar; timestamp: ISC_TIMESTAMP_TZ): ProfilerSession; cdecl;
begin
	Result := nil;
...
procedure ProfilerSessionImpl_defineStatementDispatcher(this: ProfilerSession; status: Status; statementId: Int64; parentStatementId: Int64; type_: PAnsiChar; packageName: PAnsiChar; routineName: PAnsiChar; sqlText: PAnsiChar); cdecl;
begin
	ProfilerSessionImpl(this).defineStatement(status, statementId, parentStatementId, type_, packageName, routineName, sqlText);
end;

procedure ProfilerSessionImpl_defineCursorDispatcher(this: ProfilerSession; statementId: Int64; cursorId: Cardinal; name: PAnsiChar; line: Cardinal; column: Cardinal); cdecl;
begin
	ProfilerSessionImpl(this).defineCursor(statementId, cursorId, name, line, column);
end;

procedure ProfilerSessionImpl_defineRecordSourceDispatcher(this: ProfilerSession; statementId: Int64; cursorId: Cardinal; recSourceId: Cardinal; level: Cardinal; accessPath: PAnsiChar; parentRecSourceId: Cardinal); cdecl;
begin
	ProfilerSessionImpl(this).defineRecordSource(statementId, cursorId, recSourceId, level, accessPath, parentRecSourceId);
end;

procedure ProfilerSessionImpl_onRequestStartDispatcher(this: ProfilerSession; status: Status; statementId: Int64; requestId: Int64; callerStatementId: Int64; callerRequestId: Int64; timestamp: ISC_TIMESTAMP_TZ); cdecl;
begin
	ProfilerSessionImpl(this).onRequestStart(status, statementId, requestId, callerStatementId, callerRequestId, timestamp);
end;

procedure ProfilerSessionImpl_onRequestFinishDispatcher(this: ProfilerSession; status: Status; statementId: Int64; requestId: Int64; timestamp: ISC_TIMESTAMP_TZ; stats: ProfilerStats); cdecl;
begin
	ProfilerSessionImpl(this).onRequestFinish(status, statementId, requestId, timestamp, stats);
end;

procedure ProfilerSessionImpl_beforePsqlLineColumnDispatcher(this: ProfilerSession; statementId: Int64; requestId: Int64; line: Cardinal; column: Cardinal); cdecl;
begin
	ProfilerSessionImpl(this).beforePsqlLineColumn(statementId, requestId, line, column);
end;

procedure ProfilerSessionImpl_afterPsqlLineColumnDispatcher(this: ProfilerSession; statementId: Int64; requestId: Int64; line: Cardinal; column: Cardinal; stats: ProfilerStats); cdecl;
begin
	ProfilerSessionImpl(this).afterPsqlLineColumn(statementId, requestId, line, column, stats);
end;

procedure ProfilerSessionImpl_beforeRecordSourceOpenDispatcher(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal); cdecl;
begin
	ProfilerSessionImpl(this).beforeRecordSourceOpen(statementId, requestId, cursorId, recSourceId);
end;

procedure ProfilerSessionImpl_afterRecordSourceOpenDispatcher(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats); cdecl;
begin
	ProfilerSessionImpl(this).afterRecordSourceOpen(statementId, requestId, cursorId, recSourceId, stats);
end;

procedure ProfilerSessionImpl_beforeRecordSourceGetRecordDispatcher(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal); cdecl;
begin
	ProfilerSessionImpl(this).beforeRecordSourceGetRecord(statementId, requestId, cursorId, recSourceId);
end;

procedure ProfilerSessionImpl_afterRecordSourceGetRecordDispatcher(this: ProfilerSession; statementId: Int64; requestId: Int64; cursorId: Cardinal; recSourceId: Cardinal; stats: ProfilerStats); cdecl;
begin
...
type
  TVector = array[0..4] of NativeIntPtr;
  TVectorP = ^TVector;
...
begin
  ...
  try
    ...
    LErrorText := String(StrPas(PAnsiChar(LErrorArray[3])));
  finally
    inherited Create(LErrorText);
  end;
end;
...
class procedure FbException.setVersionError(status: Status; interfaceName: AnsiString;
		currentVersion, expectedVersion: NativeInt);
var
